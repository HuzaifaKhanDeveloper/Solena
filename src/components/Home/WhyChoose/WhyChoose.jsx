...
const cardData = [
  {
    ...
    title: "Trade",
    description:
      "Effortlessly swap or trade with speed and cost efficiency using our intuitive app.",
    shortdesc: "Enter Exchange",
    icon: { normal: Shape1, hover: Hover1, size: true },
  },
  {
    id: 1,
    title: "Yield",
    description:
      "Generate yield through transaction fees and participate in yield farming opportunities.",
  ...
  },
  {
    ...
    title: "Pool",
    description:
      "Provide liquidity for any SPL token effortlessly.",
  ...
  },
  {
    ...
    title: "Launchpad",
    description:
      "Discover a launchpad for pioneering Solana projects.",
