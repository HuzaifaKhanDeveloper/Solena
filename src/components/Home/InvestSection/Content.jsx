  ...
  return (
    <>
      <div className=" flex flex-col md:gap-8 gap-2 md:my-10 md:px-0 px-5">
        ...
        />
        <h2 className="font-extrabold  text-5xl md:text-7xl heading_invest">Invest</h2>
        ...
        <div className=" flex flex-col md:py-2 py-3 md:gap-0 gap-2">
          ...
          <div className=" flex w-full justify-start items-center gap-4">
            <div className=" flex flex-col">
              <h3 className="font-bold text-5xl md:text-6xl text-[#5F78FF]">
                {timeLeft.days}
              </h3>
            ...
            <div className=" flex flex-col">
              <h3 className="font-bold text-5xl md:text-6xl text-[#5595E9]">
                {timeLeft.hours}
              </h3>
              <span className="md:text-sm text-[13px] font-medium text-[#7979AC] text-center">
                Hours
            ...
            <div className=" flex flex-col">
              <h3 className="font-bold text-5xl md:text-6xl text-[#4AB3D0]">
                {timeLeft.minutes}
              </h3>
              <span className="md:text-sm text-[13px] font-medium text-[#7979AC] text-center">
                Min
            ...
            <div className=" flex flex-col md:w-16 w-10">
              <h3 className="font-bold text-5xl md:text-6xl text-[#3FD2B7]">
                {timeLeft.seconds}
              </h3>
              <span className="md:text-sm text-[13px] font-medium text-[#7979AC] text-center">
                Sec
        ...
        <div className=" flex md:flex-row flex-col md:gap-8 gap-0 items-center mb-10">
          ...
          <div className=" flex gap-0  mt-6">
            <a href="https://twitter.com/solenaai" target="_blank">
            <img src={twitter} />
            </a>
            <a href="https://t.me/SolenaAI" target="_blank">
            <img src={telegram} />
            </a>
          </div>
        </div>
