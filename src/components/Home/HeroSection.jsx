  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-10 mx-auto md:mt-20 md:my-0 my-3">
        ...
        {/* card */}
       <div className="flex md:flex-row flex-col md:justify-between justify-center items-center gap-2 md:gap-16 md:px-16 md:py-5 hero-section" style={{ backgroundColor: '#1B1B36', border: '1px solid #4FA5DC' }} >
